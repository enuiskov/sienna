...
{
	public partial class GdiGLFrame : GLFrame, IGdiFrame
	{
		public virtual void DrawBackground(GraphicsContext iGrx)
		{
			...
			var _Brush = new LinearGradientBrush(new Rectangle(0,0,this.Width,this.Height), this.Palette.BackGradTopColor, this.Palette.BackGradBottomColor, 90f);
			
			//var _ = new Linear


			iGrx.FillPath(_Brush, _Path);
			iGrx.DrawPath(new Pen(this.Palette.Fore, 1f), _Path);

			//iGrx.DrawRectangle(new Pen(this.Palette.Fore, 1f), new Rectangle(0,0,this.Width-1, this.Height-1));
		}
