...
namespace AE.Editor
{
	public class FillerGraphicsControl : GraphicsEngineControl
	{
		...
		public void GenerateRectangles() ///~~ linestrip;
		{
			var _Rng = new Random(0);

			this.Rectangles = new RectangleData[50000];
			{
				for(var cRi = 0; cRi < this.Rectangles.Length; cRi ++)
				{
					var cX = _Rng.Next(this.Width  - 100);
					var cY = _Rng.Next(this.Height - 100);
					var cW = 5;
					var cH = 5;
					var cColor = Color.FromArgb(255, _Rng.Next(255),_Rng.Next(255),_Rng.Next(255));

					this.Rectangles[cRi] = new RectangleData
					{
						Coords = new Rectangle(cX,cY,cW,cH),
						Color = (uint)cColor.ToArgb()
					};
				}
			}
		...
		public override void RedrawGraphics()
		{
			...
			this.DrawRectanglesDLL(_Ctx, _Time);
